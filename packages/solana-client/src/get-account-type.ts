...
export type AccountType = AccountTokenType | 'system' | 'system-program' | 'unknown'

export function getAccountType({ account }: { account: AccountInfoWithParsedData }): AccountType {
