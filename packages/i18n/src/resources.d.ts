...
interface Resources {
  ...
  explorer: {
    account: 'Account'
    accountOverviewErrorTitle: 'Error getting account overview'
    accountOverviewTitle: 'Account overview'
    accountTokensEmpty: 'No tokens found.'
    accountTokensTitle: 'Tokens'
    accountTransactionsEmpty: 'No transactions found.'
    ...
    supply: 'Supply'
    token: 'Token'
    transactionCopyBase64: 'Copy base64 transaction'
    transactionCopyBase64Failed: 'Failed to copy transaction'
    transactionCopyBase64Success: 'Transaction copied to clipboard'
    unexpectedParsedTokenAccountData: 'Unexpected parsed token account data'
    unexpectedParsedTokenMintData: 'Unexpected parsed token mint data'
  ...
  onboarding: {
    ...
    passwordButtonContinue: 'Continue'
    passwordCardDescription: 'This password unlocks your wallet on this device.'
    passwordCardTitle: 'Secure your wallet'
  ...
  portfolio: {
    ...
    actionSelectAmount: 'Select amount'
    actionSelectDestination: 'Select destination'
    actionSelectToken: 'Select token'
    actionSend: 'Send'
    actionUseFaucet: 'Use faucet'
    burnNoBalanceDescription: 'This token account does not have any tokens available to burn.'
    burnNoBalanceTitle: 'No tokens to burn'
    burnTokens: 'Burn tokens'
    errorInvalidTokenAccountMessage: 'Account is not a parsed token account'
    errorInvalidTokenAccountTitle: 'Invalid token account'
    errorNoAddressMessage: 'Parameter address is unknown'
    errorNoAddressTitle: 'No address'
    errorNoTokenAccountInfoMessage: 'Error fetching token account info'
    errorNoTokenAccountInfoTitle: 'No token account info'
    errorUnsupportedTokenProgramMessage: 'Unsupported token account program'
    errorUnsupportedTokenProgramTitle: 'Unsupported token program'
    errorWatchedAccountMessage: 'Watched accounts do not have a secret key'
    errorWatchedAccountTitle: 'Unable to burn token'
    ...
    sendConfirmAddressLabel: 'Address'
    sendConfirmChangeLabel: 'Change'
    ...
    sendConfirmPreparingTransaction: 'Preparing transaction...'
    sendConfirmSimulatingTransaction: 'Simulating transaction...'
    sendConfirmSimulationFailed: 'Simulation failed'
    sendConfirmSimulationFailedDescription: 'The transaction was not sent.'
    sendConfirmTokenLabel: 'Token'
    sendConfirmTransactionPreview: 'Transaction preview'
    sendDestinationFromBadge: 'From'
    sendInputAccountLabel: 'Account'
    sendInputAmountLabel: 'Amount'
    sendInputAmountPlaceholder: 'Amount'
    sendInputDestinationBookmarksEmpty: 'No bookmarks yet.'
    sendInputDestinationBookmarksGroupLabel: 'Bookmarks'
    sendInputDestinationBookmarksNotFound: 'No bookmarks found.'
    sendInputDestinationInvalid: 'Invalid Solana address'
  ...
  settings: {
    accountDeleteDescription: 'This action cannot be undone.'
    accountDeleteTitle: 'Are you sure you want to delete this account?'
    ...
    networkInputColorDescription: 'Select the color for this network'
    networkInputColorLabel: 'Color'
    networkInputColorUnset: 'Unset color'
    ...
    pageGeneralApiSettings: 'API settings'
    ...
    pageSecurityDescription: 'Manage wallet password and lock state'
    pageSecurityName: 'Security'
    pageWalletDescription: 'Manage wallets and accounts'
    pageWalletName: 'Wallets'
    securityActionCreateVault: 'Create vault'
    securityActionLock: 'Lock'
    securityActionUnlock: 'Unlock'
    securityInputConfirmPasswordLabel: 'Confirm password'
    securityInputPasswordLabel: 'Password'
    securityStatusConfigured: 'Vault configured'
    securityStatusLocked: 'Locked'
    securityStatusMissing: 'Vault not configured'
    ...
    walletDeleteDescription: 'This action cannot be undone.'
    walletDeleteTitle: 'Are you sure you want to delete this wallet?'
    ...
    walletProtectionActionSave: 'Save protection'
    walletProtectionCurrentLabel: 'Current protection'
    walletProtectionPassword: 'Use vault password'
    walletProtectionPin: 'Use PIN'
    walletProtectionPinConfirmLabel: 'Confirm PIN'
    walletProtectionPinLabel: 'PIN'
    ...
    walletProtectionUnsecuredWarning: 'Use only for public dev wallets. Anyone with this browser data can recover it.'
  }
  shell: {
