...
export default function ToolsFeatureCreateToken(props: {
  cluster: Cluster;
  wallet: Wallet;
}) {
  ...
  const handleCreateToken = useCallback(async (): Promise<void> => {
    ...
    console.log(
      "Mint",
      getExplorerUrl({ cluster: props.cluster, path: `/address/${res.mint}` }),
    );
    console.log(
      "TX",
      getExplorerUrl({ cluster: props.cluster, path: `/tx/${res.signature}` }),
    );
      ...
      {resultMint && resultTx ? (
        ...
        <div className="flex flex-col gap-6">
          <Field>
            ...
            <div className="flex items-center gap-2">
              <Input
                ...
                readOnly
                required
                value={queryKeypair.data?.address}
              />
              <Button
          ...
          <Field>
            ...
            <FieldDescription>
              The amount of tokens to mint after creation
            </FieldDescription>
            <Input
              id="supply"
              min={0}
          ...
          <Item variant="outline">
            <ItemContent>
              ...
              <ItemDescription className="font-mono">
                Cluster: {getClusterLabel(props.cluster.type)}
              </ItemDescription>
              <ItemDescription className="font-mono">
