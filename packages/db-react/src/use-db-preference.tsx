...
import { useDbPreferenceGetValueLive } from "./use-db-preference-get-value-live.tsx";
import { useDbPreferenceSetValue } from "./use-db-preference-set-value.tsx";

export function useDbPreference(
  key: PreferenceKey,
): [null | string, (newValue: string) => Promise<void>] {
