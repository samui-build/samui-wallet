...
>;
export type DbAccountDeleteMutateOptions = MutateOptions<
  void,
  Error,
  { id: string }
>;
export type DbAccountSetActiveMutateOptions = MutateOptions<
  void,
  Error,
  { id: string }
>;
export type DbAccountUpdateMutateOptions = MutateOptions<
  number,
  Error,
...
export const dbAccountOptions = {
  create: (props: DbAccountCreateMutateOptions = {}) =>
    mutationOptions({
      mutationFn: ({ input }: { input: AccountInputCreate }) =>
        dbAccountCreate(db, input),
      ...props,
    }),
  ...
  update: (props: DbAccountUpdateMutateOptions = {}) =>
    mutationOptions({
      mutationFn: ({ id, input }: { id: string; input: AccountInputUpdate }) =>
        dbAccountUpdate(db, id, input),
      ...props,
    }),
};
