...
import type {
  ExplorerGetTransactionResult,
  ExplorerGetTransactionResultInstruction,
} from '../data-access/use-explorer-get-transaction.ts'
...
export function ExplorerUiTxInstructionsItem({
  ...
  basePath: string
  index: number
  meta: ExplorerGetTransactionResult['meta']
