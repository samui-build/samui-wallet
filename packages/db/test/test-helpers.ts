...
export function testAccountInputCreate(
  input: Partial<AccountInputCreate> = {},
): AccountInputCreate {
  return {
    derivationPath: "d",
    mnemonic: "baz",
...
export function testClusterInputCreate(
  input: Partial<ClusterInputCreate> = {},
): ClusterInputCreate {
  return {
...
export function testPreferenceInputSet(
  value?: string,
): [PreferenceKey, string] {
  return ["activeClusterId", value ?? randomName("preference")];
}

export function testWalletInputCreate(
  input: { accountId: string } & Partial<WalletInputCreate>,
): WalletInputCreate {
  return {
