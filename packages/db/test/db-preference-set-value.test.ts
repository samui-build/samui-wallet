...
describe("db-preference-set-value", () => {
  ...
  describe("unexpected behavior", () => {
    ...
    it("should throw an error with an empty value", async () => {
      ...
      // ACT & ASSERT
      await expect(dbPreferenceSetValue(db, key, "")).rejects.toThrow(
    ...
    it("should throw an error when creating a preference fails", async () => {
      ...
      // ACT & ASSERT
      await expect(dbPreferenceSetValue(db, key, value)).rejects.toThrow(
    ...
    it("should throw an error when updating a preference fails", async () => {
      ...
      // ACT & ASSERT
      await expect(
        dbPreferenceSetValue(db, key, "updated-value"),
      ).rejects.toThrow("Error updating preference");
    });
  });
});
